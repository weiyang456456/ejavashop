...
<body>
	<div>
		<div id="san">
			<div id="san_01">搜索词历史纪录列表</div>
			<div id="san_02">
				搜索词：<input type="text" name="" id="san_02_01">
			</div>
		</div>
		<div id="si">
			...
			<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'username', width:200}">搜索词</th>
						<th lay-data="{field:'sex', width:200}">IP地址</th>
						<th lay-data="{field:'city', width:200}">cookie埋点</th>
						<th lay-data="{field:'sign', width:110}">用户ID</th>
						<th
							lay-data="{field:'score', width:150, sort: true, fixed: 'right'}">添加时间</th>
						<th
