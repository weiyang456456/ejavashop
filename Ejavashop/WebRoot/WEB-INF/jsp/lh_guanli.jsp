...
<html>
  <head>
    ...
    <title>My JSP 'lh_guanli.jsp' starting page</title>
    ...
    <div class="info">
    	<form action="#">
        	...
        	<div class="two">
                ...
                <a href="${pageContext.request.contextPath }/lh_print" target="iframe_b" style="text-decoration:none;"><img src="statics/images/shizijia.png"/>新增</a>
            	<a><img src="statics/images/qianbi.png">编辑</a> 
            	<a><img src="statics/images/qianbi.png">冻结</a>
            	<a><img src="statics/images/qianbi.png">解冻</a>
