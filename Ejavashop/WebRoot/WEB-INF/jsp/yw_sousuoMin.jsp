...
<body>
	<div>
		<div id="san">
			<div id="san_01">敏感词列表</div>
			<div id="san_02">
				敏感词：<input type="text" name="" id="san_02_01">
			</div>
		</div>
		<div id="si">
			...
			<a href="${pageContext.request.contextPath }/yw_sousuo/yw_sousuoMinAdd" id="si_04">添加</a> 
			<i class="fa fa-paint-brush" aria-hidden="true" id="si_05" style="width: 17px;height: 17px;position: absolute;top: 6px;"></i>
			<a href="${pageContext.request.contextPath }/yw_sousuo/yw_sousuoMinBian" id="si_06">修改</a> 
			...
			<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'username', width:300}">敏感词</th>
						<th lay-data="{field:'sex', width:300, sort: true}">添加时间</th>
						<th
							lay-data="{field:'score', width:200, sort: true, fixed: 'right'}">添加人</th>
						<th
  ...
  <a href="${pageContext.request.contextPath }/yw_sousuo/yw_sousuoMinBian" class="layui-btn layui-btn-mini" lay-event="edit">编辑</a>
