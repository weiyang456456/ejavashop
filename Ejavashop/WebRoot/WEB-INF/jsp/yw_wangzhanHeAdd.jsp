...
<body>
	<div class="layui-side layui-bg-black" style="width: 1164px;">
		<div id="san">
			<div id="san_01">合作伙伴列表</div>
		</div>
		<div id="liu"
			style="position: absolute;top:36px;left: 0px;height: 795px;background-color: #fff;color: #000;">
			<div id="liu_01">
				新增合作伙伴 <span style="position:absolute;top:0px;right:25px;"> <i
					class="fa fa-reply" aria-hidden="true"></i>&nbsp; <a
					href="${pageContext.request.contextPath }/yw_wangzhan/yw_wangzhanHe">返回</a>
				</span>
			</div>
					...
					<fieldset class="layui-elem-field"
						...
						<div class="layui-form-item">
							<label class="layui-form-label"><span
								style="color:#F00;font-size:20px;position:absolute;top:14px;left:55px;">*</span>名称:</label>
							<div class="layui-input-block">
								<input type="text" name="" lay-verify="title" autocomplete="off"
									placeholder="请输入名称" class="layui-input" style="width: 833px;">
							</div>
						</div>
						<div class="layui-inline" style="margin-bottom: 15px;">
      						<label class="layui-form-label"><span style="color:#F00;font-size:20px;position:absolute;top:14px;left:55px;">*</span>状态:</label>
    					...
    					<div class="layui-form-item">
    						<label class="layui-form-label"><span style="color:#F00;font-size:20px;position:absolute;top:14px;left:27px;">*</span>企业logo:</label>
    						<div class="layui-input-block">
						...
						<div class="layui-form-item">
							<label class="layui-form-label"><span
								style="color:#F00;font-size:20px;position:absolute;top:14px;left:55px;">*</span>链接:</label>
							<div class="layui-input-block">
								<input type="text" name="" lay-verify="title" autocomplete="off"
									placeholder="请输入链接地址" class="layui-input" style="width: 833px;">
							</div>
						</div>
					</fieldset>
					<div class="layui-form-item">
