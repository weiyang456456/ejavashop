...
<html>
  <head>
    ...
    <title>My JSP 'lh_daishou.jsp' starting page</title>
    ...
    <div class="info">
    	<form action="#">
        	...
        	<div class="two">
            	...
            	<a><img src="statics/images/yvlan.png">提交审核</a>
                <a href="${pageContext.request.contextPath }/lh_print" target="iframe_b" style="text-decoration:none;"><img src="statics/images/shizijia.png"/>上架</a>
                <a><img src="statics/images/dayingji.png">库存价格设置</a>
            </div>
        </form>
        <div class="three">
