...
<body>
	<div>
		...
		<div id="liu" style="position: absolute;top:36px;left: 0px;height: 458px;">
			<div id="liu_01">
				添加推荐商品
				<span style="position:absolute;top:0px;right:10px;">
                	<i class="fa fa-reply" aria-hidden="true"></i>&nbsp;
                    <a href="${pageContext.request.contextPath }/yw_index/yw_PCshouyeTui">返回</a>
                </span>
			</div>
			<form class="layui-form" action="">
				<div id="liu_02">
					<fieldset class="layui-elem-field" style="width:1137px;margin-left:13px;margin-top:10px;height:365px;">
						<legend>基本信息</legend>
						<div class="layui-field-box">
							<div class="layui-inline" style="margin-bottom: 15px;">
      							<label class="layui-form-label"><span style="color:#F00;font-size:20px;position:absolute;top:14px;left:27px;">*</span>推荐类型</label>
      							<div class="layui-input-inline">
        							<select name="modules" lay-verify="required" lay-search="">
          								<option value="">直接选择或搜索选择</option>
          								<option value="1">PC首页热销商品</option>
  							...
  							<div class="layui-form-item">
    							<label class="layui-form-label"><span style="color:#F00;font-size:20px;position:absolute;top:14px;left:27px;">*</span>推荐时间</label>
    							<div class="layui-input-block">
      								<input type="text" name="" lay-verify="required"  autocomplete="off" placeholder="请输入开始推荐时间" class="layui-input" style="width:400px;"><span style="position:absolute;top:10px;left:410px;font-size:22px;">~</span>
                                    <input type="text" name="" lay-verify="required"  autocomplete="off" placeholder="请输入结束推荐时间" class="layui-input" style="width:400px;position:absolute;top:0px;left:433px;">
    							</div>
  							</div>
