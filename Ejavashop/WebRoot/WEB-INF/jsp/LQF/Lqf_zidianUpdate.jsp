...
<html>
  <head>
    ...
    <title>My JSP 'Lqf_zidianUpdate.jsp' starting page</title>
...
<table>
	...
	<td>
    是否使用:
    <input type="radio"  value="使用"  name="sy"/>使用
    <input type="radio"  value="不使用"  name="sy"/>不使用
    </td>
	</tr>
</table>
