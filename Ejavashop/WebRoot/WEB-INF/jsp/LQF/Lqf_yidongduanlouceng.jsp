...
<td width="29%"><a href="${pageContext.request.contextPath }/Lqf_yidongduanloucengAdd"><input type="button" value="新增" /></a>
<td width="29%"><a href="#"><input type="submit" value="修改" /></a>
