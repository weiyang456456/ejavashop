...
<html>
  <head>
    ...
    <title>My JSP 'Lqf_jueseguanli.jsp' starting page</title>
...
<tr>
<td width="14%"><a href="${pageContext.request.contextPath }/Lqf_jueseAdd">新增</a></td>
<td width="14%"><a href="${pageContext.request.contextPath }/Lqf_jueseUpdate">编辑</a></td>
<td width="15%"><a href="#">删除</a></td>
<td width="26%"><a href="#">分配权限</a></td>
<td width="31%"><a href="#"><input type="submit" value="查询" /></a>
</tr>
</form>
</table>
