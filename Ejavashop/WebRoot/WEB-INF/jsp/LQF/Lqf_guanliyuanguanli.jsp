...
<html>
  <head>
    ...
    <title>My JSP 'Lqf_guanliyuanguanli.jsp' starting page</title>
...
<tr>
<td width="29%"><a href="${pageContext.request.contextPath }/Lqf_guanliyuanAdd">新增</a></td>
<td width="23%"><a href="#">修改</a></td>
<td width="23%">冻结</td>
<td width="23%">删除</td>
<td width="23%"><a href="#"><input type="submit" value="查询" /></a>
</tr>
</form>
</table>
