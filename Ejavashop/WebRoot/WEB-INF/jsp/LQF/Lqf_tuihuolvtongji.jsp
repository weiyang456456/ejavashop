...
<div class="c2">
<div class="h1">浏览量统计</div>
<form action="" method="post">
<table width="85%" border="0" cellspacing="0" bgcolor="#E3EBF2" class="h2">
<tr><td><input type="radio">按年份<input type="radio">按月份<input type="checkbox">按商家</td></tr>
<tr>
...
购买率统计展示网店在一段时间内的有效与这些订单相关的总访问数量的比值;可以按照年度和月份为单位,分别进行
</div>
  </body>
</html>
