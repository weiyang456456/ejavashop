...
<body>
			...
			<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'username', width:200}">名称</th>
						<th lay-data="{field:'sex', width:110}">logo</th>
						<th lay-data="{field:'sex1', width:300}">链接</th>
						<th lay-data="{field:'sex2', width:110}">是否可见</th>
						<th lay-data="{field:'sex3', width:110}">排序</th>
						<th
							lay-data="{field:'score', width:200, sort: true, fixed: 'right'}">创建时间</th>
						<th
  ...
  <a href="${pageContext.request.contextPath }/yw_wangzhan/yw_wangzhanHeBian" class="layui-btn layui-btn-mini" lay-event="edit">编辑</a>
