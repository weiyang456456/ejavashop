...
<body>
	<div>
		<div id="san">
			...
			<div id="san_02">
				文章标题：<input type="text" name="" id="san_02_01">
				文章内容：<input type="text" name="" id="san_02_02">
			</div>
		</div>
		<div id="si">
			<i class="fa fa-plus" aria-hidden="true" id="si_01" style="width: 17px;height: 17px;position: absolute;top: 6px;"></i>
			<a href="${pageContext.request.contextPath }/yw_wangzhan/yw_wangzhanWenGuanAdd" id="si_02">增加</a> 
			<i class="fa fa-paint-brush" aria-hidden="true" id="si_03" style="width: 17px;height: 17px;position: absolute;top: 6px;"></i>
			<a href="${pageContext.request.contextPath }/yw_wangzhan/yw_wangzhanWenGuanBian" id="si_04">修改</a> 
			...
			<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'username', width:110}">所属分类</th>
						<th lay-data="{field:'sex', width:300}">新闻标题</th>
						<th lay-data="{field:'sex1', width:80}">作者</th>
						<th lay-data="{field:'sex2', width:150}">外部链接</th>
						<th lay-data="{field:'sex3', width:300}">外部URL</th>
						<th lay-data="{field:'sex4', width:110}">是否显示</th>
						<th lay-data="{field:'sex5', width:110}">是否推荐</th>
						<th lay-data="{field:'sex6', width:300}">创建时间</th>
						<th lay-data="{field:'sex7', width:300}">最后更新</th>
						<th
  ...
  <a href="${pageContext.request.contextPath }/yw_wangzhan/yw_wangzhanWenGuanBian" class="layui-btn layui-btn-mini" lay-event="edit">编辑</a>
