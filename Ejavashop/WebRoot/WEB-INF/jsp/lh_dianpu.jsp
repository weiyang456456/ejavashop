...
<title>My JSP 'lh_dianpu.jsp' starting page</title>
			...
			<form action="#">
				<div class="two">
					<a href="${pageContext.request.contextPath }/lh_carAdd"
						...
						type="image" class="img" src="statics/images/shizijia.png" />添加</a> <a
						href="${pageContext.request.contextPath }/lh_tuiAdd"
						target="iframe_b" style="text-decoration:none;"><img
						src="statics/images/qianbi.png" />编辑</a> <input type="image"
						class="img" src="statics/images/shanchu.png" />删除
				</div>
			</form>
			<div class="three">
				<table>
