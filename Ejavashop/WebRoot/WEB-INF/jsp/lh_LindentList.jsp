...
<html>
  <head>
    ...
    <title>My JSP 'lh_LindentList.jsp' starting page</title>
    ...
    <div class="info">
    	<form action="#">
        	...
        	<div class="two">
                ...
                <a href="${pageContext.request.contextPath }/lh_print" target="iframe_b" style="text-decoration:none;"><img src="statics/images/shizijia.png"/>打印</a>
                <a><img src="statics/images/qianbi.png" />编辑</a>
                <a><img src="statics/images/qianbi.png" />取消</a>
                <a><img src="statics/images/qianbi.png" />确认</a>
                <a><img src="statics/images/qianbi.png" />发货</a>
            </div>
        </form>
        <div class="three">
