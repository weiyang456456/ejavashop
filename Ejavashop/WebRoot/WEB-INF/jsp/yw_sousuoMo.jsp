...
<body>
	<div>
		<div id="san">
			...
			<div id="san_02">
				模糊搜索词列表：<input type="text" name="" id="san_02_01">
			</div>
		</div>
		<div id="si">
			...
			<a href="${pageContext.request.contextPath }/yw_sousuo/yw_sousuoMoAdd" id="si_04">添加</a> 
			<i class="fa fa-paint-brush" aria-hidden="true" id="si_05" style="width: 17px;height: 17px;position: absolute;top: 6px;"></i>
			<a href="${pageContext.request.contextPath }/yw_sousuo/yw_sousuoMoBian" id="si_06">修改</a> 
			...
			<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'username', width:200}">模糊搜索词</th>
						<th lay-data="{field:'sex', width:200, sort: true}">模糊搜索词拼音</th>
						<th lay-data="{field:'city', width:200}">模糊搜索词索引数量</th>
						<th lay-data="{field:'sign', width:200}">添加时间</th>
						<th
							lay-data="{field:'score', width:200, sort: true, fixed: 'right'}">最后修改人</th>
						<th
  ...
  <a href="${pageContext.request.contextPath }/yw_sousuo/yw_sousuoMoBian" class="layui-btn layui-btn-mini" lay-event="edit">编辑</a>
