...
<body>
	<div>
		<div id="san">
			...
			<div id="san_02">
				...
				<span id="san_02_02"> 名称：<input type="text" name="" id="san_02_01">
				</span>
		...
		<div id="si">
			<img id="si_01"
				...
				width="17" height="17" /> <a href="${pageContext.request.contextPath }/yw_index/yw_PCshouyeLouFenAdd" id="si_04">新增</a> <img
				id="si_05"
				src="${pageContext.request.contextPath }/statics/images/qianbi.png"
				width="17" height="17" /> <a href="${pageContext.request.contextPath }/yw_index/yw_PCshouyeLouFenBian" id="si_06">修改</a> <img
				id="si_07"
			...
			<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'city', width:110}">所属楼层</th>
  ...
  <a href="${pageContext.request.contextPath }/yw_index/yw_PCshouyeLouFenBian" class="layui-btn layui-btn-mini" lay-event="edit">编辑</a>
