...
<html>
  <head>
    ...
    <title>My JSP 'xm_tuangoutuUpd.jsp' starting page</title>
            	...
            	<fieldset>
                    ...
                    <table class="table_1">
                    	<tr>
                        	...
                        	<td style="text-align:left"><input type="text" value="mobile2"></td>
                       	</tr>
                       <tr>
                    		<td style="text-align:right; width:20%"><span>*</span>链接地址：</td>
                        	<td style="text-align:left"><input type="text" value="/product/6.html"></td>
                       	</tr>
                        <tr>
                        ...
                        <tr>
                       	...
                       	<tr>
                        	...
                        	<td style="text-align:left"><input type="text" value="1"></td>
                       	</tr>
                       	<tr>
                    		<td style="text-align:right; width:20%"></td>
