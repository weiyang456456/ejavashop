...
<body>
	<div>
		<div id="san">
			...
			<div id="san_02">
				楼层名称：<input type="text" name="" id="san_02_01">
				<span id="san_02_02"> 状态： 
					<select name="">
						<option>—全部—</option>
						<option>使用</option>
						<option>预使用</option>
		...
		<div id="si">
			<img id="si_01"
				...
				width="17" height="17" /> <a href="${pageContext.request.contextPath }/yw_index/yw_PCshouyeLouAdd" id="si_04">新增</a> <img
				id="si_05"
				src="${pageContext.request.contextPath }/statics/images/qianbi.png"
				width="17" height="17" /> <a href="${pageContext.request.contextPath }/yw_index/yw_PCshouyeLouBian" id="si_06">修改</a> <img
				id="si_07"
			...
			<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'username', width:50}">加号</th>
						<th lay-data="{field:'username', width:110}">名称</th>
						<th lay-data="{field:'sex', width:110, sort: true}">排序号</th>
						<th lay-data="{field:'city', width:80}">主图</th>
						<th lay-data="{field:'sign', width:200}">主图链接地址</th>
						<th lay-data="{field:'experience', width:80, sort: true}">顶图</th>

						<th lay-data="{field:'classify', width:200}">顶图链接地址</th>
						<th lay-data="{field:'wealth', width:110, sort: true}">使用状态</th>
  ...
  <a href="${pageContext.request.contextPath }/yw_index/yw_PCshouyeLouBian" class="layui-btn layui-btn-mini" lay-event="edit">编辑</a>
