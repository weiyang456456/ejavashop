...
<html>
  <head>
    ...
    <title>My JSP 'lc_carsjList.jsp' starting page</title>
...
<body>
	<div id="divs">
		<div id="head1">
		<div  style="margin-top: -1px;">PC端推存数据列表
	</div>
	</div>
<div id="div2">
 <table width="400" class="table1">
    ...
    <div id="div">
        ...
        <a href="lc_index/carsjAdd">新 增</a>&nbsp;<img src="${pageContext.request.contextPath }/statics/images/qianbi.png"/>
        <a href="lc_index/carsjUpdate">修 改</a>&nbsp;<img src="${pageContext.request.contextPath }/statics/images/yvlan.png"/>
        <a href="">预 览</a>
    </div>
 <div id="div1" style="position: absolute;top: 105px;left: 0px;"> 
  ...
  <thead>
    <tr>
      ...
      <th lay-data="{field:'username', width:100}">推存类型</th>
      <th lay-data="{field:'sex', width:100}">书籍类型</th>
      <th lay-data="{field:'city', width:100}">商品名称</th>
      <th lay-data="{field:'sign', width:100}">图片标题</th>
      <th lay-data="{field:'experience', width:100}">链接地址</th>
      <th lay-data="{field:'experience', width:100}">查看图片</th>
      <th lay-data="{field:'experience', width:100, sort: true}">排序号</th>
      <th lay-data="{field:'experience', width:80}">备注</th>
