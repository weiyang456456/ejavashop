...
<html>
  <head>
    ...
    <title>My JSP 'lc_carlxList.jsp' starting page</title>
...
<body>
	<div id="divs">
		<div id="head1">
		<div style="margin-top: -1px;">PC端推存类型列表
	</div>
	</div>
<div id="div2">
 <table width="400" class="table1">
          <tr id="tr">
              <td>推存标题：<input type="text" name=""></td>
    ...
    <div id="div">
        ...
        <a href="lc_index/carlxAdd">新 增</a>&nbsp;<img src="${pageContext.request.contextPath }/statics/images/qianbi.png"/>
        <a href="lc_index/carlxUpdate">修 改</a>&nbsp;<img src="${pageContext.request.contextPath }/statics/images/shanchu.png"/>
  ...
  <thead>
    <tr>
      ...
      <th lay-data="{field:'username', width:100}">推存标题</th>
      <th lay-data="{field:'sex', width:80, sort: true}">排序号</th>
      <th lay-data="{field:'city', width:100}">使用状态</th>
      <th lay-data="{field:'sign', width:140}">最后修改人</th>
