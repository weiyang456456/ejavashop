...
<html>
  <head>
    ...
    <title>My JSP 'lc_moveUpdate.jsp' starting page</title>
 ...
 <div class="tab">
      <table align="left" class="table1">
           ...
           <td><input type="file" name=""></td>
             ...
             <div class="tp"><img style="display:block;width:30%;height:30%" src="${pageContext.request.contextPath }/statics/images/2017-11-03_083526.png" /></div>
         </div>
         </fieldset>
         <div id="div3">
