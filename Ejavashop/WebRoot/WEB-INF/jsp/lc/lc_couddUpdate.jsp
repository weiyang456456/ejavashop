...
<html>
  <head>
    ...
    <title>My JSP 'lc_couddUpdate.jsp' starting page</title>
...
<div id="div1" class="layui-side-scroll">
      ...
      <table align="left" class="table1">
           <tr>
           <td align="right"><span calss="fa fa-asterisk"></span>满减活动名称:</td>
           <td><input type="text" name="" value="" style="width:300px; height:30px;" placeholder="请输入"></td>
           </tr>
            <tr>
           <td align="right">第一档:</td>
           <td><input type="text" name="" value="" style="width:300px; height:30px;" placeholder="请填写完整的地址"></td>
           </tr>
            <tr>
           <td align="right">第二档:</td>
           <td><input type="text" name="" value="" style="width:300px; height:30px;" placeholder="序号越小越靠前显示"></td>
           </tr>
            <tr>
           <td align="right">第三档:</td>
           <td><input type="text" name="" value="" style="width:300px; height:30px;" placeholder="序号越小越靠前显示"></td>
           </tr>
            <tr>
           <td align="right">活动时间:</td>
           <td><input type="date" id="datet" lay-verify="datet" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" style="width:300px; height:30px;"></td>
           <td><input type="date" id="datew" lay-verify="dates" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" style="width:300px; height:30px;"></td>
           </tr>
            <tr>
           <td align="right">应用渠道:</td>
           <td><input type="text" name="" value="" style="width:300px; height:30px;" placeholder="序号越小越靠前显示"></td>
           </tr>
            <tr>
