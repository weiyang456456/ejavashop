...
<html>
  <head>
    ...
    <title>My JSP 'lc_movelcList.jsp' starting page</title>
...
<body>
	<div id="divs">
		<div id="head1">
		<div style="margin-top: -1px;">移动端首页楼层列表
	</div>
	</div>
<div id="div2">
 <table width="400" class="table1">
          <tr id="tr">
              <td>名称：<input type="text" name=""></td>
    ...
    <div id="div">
        ...
        <a href="lc_index/movelcAdd">新 增</a>&nbsp;<img src="${pageContext.request.contextPath }/statics/images/qianbi.png"/>
        <a href="lc_index/movelcUpdate">修 改</a>&nbsp;<img src="${pageContext.request.contextPath }/statics/images/shanchu.png"/>
