...
<html>
  <head>
    ...
    <title>My JSP 'lc_carList.jsp' starting page</title>
...
<body>
	<div id="divs">
		<div id="head1">
		<div style="margin-top: -1px;">PC端首页轮播图列表
	</div>
	</div>
<div id="div2">
 <table width="800" class="table1">
  ...
  <thead>
    <tr>
      ...
      <th lay-data="{field:'sex', width:100}">链接地址</th>
      <th lay-data="{field:'city', width:100}">查看图片</th>
      <th lay-data="{field:'sign', width:80,sort: true}">排序号</th>
      <th lay-data="{field:'experience', width:100}">开始时间</th>
      
      <th lay-data="{field:'classify', width:100}">结束时间</th>
      <th lay-data="{field:'wealth', width:100}">使用状态</th>
