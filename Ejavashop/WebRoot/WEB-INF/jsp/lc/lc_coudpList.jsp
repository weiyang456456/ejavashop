...
<html>
  <head>
    ...
    <title>My JSP 'lc_coudpList.jsp' starting page</title>
...
<body>
	<div id="divs">
		<div id="head1">
		<div style="margin-top: -1px;">单品立减列表
	</div>
	</div>
<div id="div2">
 <table width="1100" class="table1">
          <tr id="tr">
              <td>活动名称：<input type="text" name=""></td>
  ...
  <thead>
    <tr>
      ...
      <th lay-data="{field:'username', width:80}">活动类型</th>
      <th lay-data="{field:'sex', width:100}">优惠额/折扣</th>
      <th lay-data="{field:'city', width:100}">开始时间</th>
      <th lay-data="{field:'sign', width:80,sort: true}">结束时间</th>
      <th lay-data="{field:'experience', width:100}">应用渠道</th>
      
      <th lay-data="{field:'classify', width:100}">状态</th>
      <th lay-data="{field:'wealth', width:100}">活动描述</th>
      <th lay-data="{field:'wealth', width:100}">审核意见</th>
