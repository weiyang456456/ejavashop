		...
		<div id="liu" style="position: absolute;top:36px;left: 0px;">
			<div id="liu_01">
				...
				<span style="position:absolute;top:0px;right:10px;">
                    ...
                    <a href="${pageContext.request.contextPath }/yw_index/yw_PCshouyeLouFen">返回</a>
                </span>
			</div>
						...
						<div class="layui-field-box">
							<div class="layui-inline" style="margin-bottom: 15px;">
  							...
  							<div class="layui-form-item">
    							<label class="layui-form-label"><span style="color:#F00;font-size:20px;position:absolute;top:14px;left:55px;">*</span>名称</label>
    							<div class="layui-input-block">
      								<input type="text" name="" lay-verify="title" autocomplete="off" placeholder="请输入名称" class="layui-input" style="width: 833px;">
    							</div>
  							</div>
  							<div class="layui-form-item">
