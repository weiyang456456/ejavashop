...
<html>
  <head>
    ...
    <title>My JSP 'xm_typeList.jsp' starting page</title>
...
<body>
	<div>
		<div id="san">
			<div id="san_01">商品类型列表</div>
			<div id="san_02">
				类型名称：<input type="text" name="" id="san_02_01"> 
			</div>
		</div>
		<div id="si">
			...
			<a href="${pageContext.request.contextPath }/xm_typeAdd" id="si_04">新增</a> 
			<i class="fa fa-paint-brush" aria-hidden="true" id="si_05" style="width: 17px;height: 17px;position: absolute;top: 6px;"></i>
			<a href="${pageContext.request.contextPath }/xm_typeUpd" id="si_06">修改</a> 
			...
			<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'username', width:120}">类型名称</th>
						<th lay-data="{field:'sex', width:200, sort: true}">关联规格</th>
						<th lay-data="{field:'city', width:150}">关联品牌</th>
						<th lay-data="{field:'wealth', width:100, sort: true}">排序</th>
						<th lay-data="{field:'sign', width:80}">创建人</th>
						<th
							lay-data="{field:'score', width:150, sort: true, fixed: 'right'}">创建时间</th>
						<th
